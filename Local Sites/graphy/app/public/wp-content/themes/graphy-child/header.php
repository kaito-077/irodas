...
<!-- 以下にスクロールリヴィールの記述　8/17 -->
<script src="https://unpkg.com/scrollreveal"></script>
<!-- 以上にスクロールリヴィールの記述　8/17 -->
...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header">
		...
		<!-- ここからスクロールリヴィールを反映　8/17.8/23 -->
		<?php graphy_site_title(); ?>

		<!-- ここまでスクロールリヴィールを反映　8/17.8/23 -->
        ...
        <!-- header画像コード管理画面　8/17 -->
        <div id="header-image" class="header-image">

        <!-- header画像を非表示　8/17 ここから -->
			<!-- <img src="<?php header_image(); ?>" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt=""> -->
        <!-- header画像を非表示　8/17　ここまで -->

        <!-- smart slider3挿入　8/17　ここから -->
			<?php echo do_shortcode('[smartslider3 slider="2"]'); ?>
        <!-- smart slider3挿入　8/17　ここまで -->
